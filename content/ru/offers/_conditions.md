...
- **13 € с человека** при предварительном бронировании;
- **16 € с человека** при запросе на месте;
- **6 € для детей** (7 € на месте), включается только полотенце для тела.
- **Частная SPA для семей**: 2 часа за **45 €** для всей семьи (по предварительному бронированию и в зависимости от наличия; доступ только для взрослых)

**Часы работы бассейна:**
- **Открытие**: 7:00 - 8:30 и 11:00 - 20:10  
...
- **2 часа частного SPA** за **45 €** для всей семьи (по предварительному бронированию и в зависимости от наличия)  
