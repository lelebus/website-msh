        ...
        <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-24">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8">
                    ...
                    <div class="gap-x-6 flex md:hidden">
                        <a v-for="item in socials" :key="item.name" :href="item.href" class="text-black/90 hover:text-black/">
            ...
            <div class="mt-8 border-t border-black/10 pt-8 sm:mt-20 lg:mt-8 md:flex md:items-center md:justify-between">
                <div class="text-sm/6">
                    ...
                    <div>
                        <span v-for="item in legalLinks" :key="item.name" class="text-black/70">
                                <a :href="item.href" class="hover:text-black/80">{{ item.name }}</a>
